...
function ByLinkTextAccessor() {
   ...
   this.toWebDriverAccessor = function(elInfo) {
      ...
      return _sahi.replaceLeadingUnderscore("findElements(By.linkText(" + _sahi.quotedEscapeValue(trimSpaces(elementText)) + ")).get(" + linkIndex + ")");    
   }
}
...
function BySmartGWTAccessor() {
   ...
   this.toWebDriverAccessor = function(elInfo) {
   	  return _sahi.replaceLeadingUnderscore("findElement(com.thoughtworks.webdriver.BySmartGWT.locator(" + _sahi.quotedEscapeValue(window.AutoTest.getLocator(elInfo.el, true)) + "))");
   }
}

Sahi.prototype.webDriverElementAccessors = [ new BySmartGWTAccessor(), new ByIdAccessor(), new ByNameRadioAccessor(), new ByNameAccessor(), new ByLinkTextAccessor(), new ByClassNameAccessor(), new ByTagNameAccessor()];
