...
Controller.prototype.informOpen = function(){
    ...
    var href = (ishttps? "https" : "http")  +"://twist.example.com/_s_/dyn/ControllerUI_opened";
...
Controller.prototype.pbSetCommon = function (method, param, value, auto){
    ...
    //$('pscript_iframe').contentWindow.location.href = "http://twist.example.com/_s_/dyn/Log_highlight?href="+encodeURIComponent(file)+"&n=0";
