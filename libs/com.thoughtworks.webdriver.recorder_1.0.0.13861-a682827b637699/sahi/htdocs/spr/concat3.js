...
//        if (this.controller.closed) {
            this.controller = window.open("http://twist.example.com/_s_/dyn/ControllerUI?sahisid="+this.sid, winName, this.getWinParams(e));
//        }
...
Sahi.INSERT_TEXT = "<script src='/_s_/spr/concat.js'></scr"+"ipt>"+
    "<script src='http://twist.example.com/_s_/dyn/SessionState/state.js'></scr"+"ipt>"+
    "<script src='http://twist.example.com/_s_/dyn/Player_script/script.js'></scr"+"ipt>"+
